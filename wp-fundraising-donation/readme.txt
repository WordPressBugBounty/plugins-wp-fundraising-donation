...
- Fixed: An unauthenticated PHP Object Injection vulnerability in the donation submission and reports functionality.
...
Version 1.7.5 //2025-06-23
- Fixed: Dashboard security issue.

Version 1.7.4 //2025-04-29
- Improved: Admin settings security.
- Fixed: Compatibility issue with WordPress 6.8.
- Fixed: Campaign details HTML format not working.

Version 1.7.3 //2025-03-23
- Fixed: Duplicate campaign issue where the same campaign appeared in multiple campaign shortcodes on a single page.
