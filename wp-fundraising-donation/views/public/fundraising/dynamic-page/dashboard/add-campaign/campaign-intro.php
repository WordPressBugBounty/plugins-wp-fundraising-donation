...
<div class="xs-form-group intro-info">
	<label for="camapign_post_name"  class="xs-col-form-label">
		<?php echo esc_html( apply_filters( 'wfp_dashboard_newcam_campaign_title', __( 'Campaign Title', 'wp-fundraising-donation' ) ) ); ?>
	</label>
...
<div class="xs-form-group intro-info">
	<label for="camapign_post_excerpt" class="xs-col-form-label">
		<?php echo esc_html( apply_filters( 'wfp_dashboard_newcam_short_description', __( 'Short Description', 'wp-fundraising-donation' ) ) ); ?>
	</label>
...
<div class="xs-form-group intro-info">
	<label for="campaign_details_editor" class="xs-col-form-label">
		<?php echo esc_html( apply_filters( 'wfp_dashboard_newcam_campign_description', __( 'Campaign Description', 'wp-fundraising-donation' ) ) ); ?>
	</label>
	<?php
