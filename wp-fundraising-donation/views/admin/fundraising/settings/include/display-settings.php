				...
				<li class="wfdp-social-input-container">
					...
					<div class="wfdp-social-input">
						<ul class="xs-donate-option">
							...
							<li>
								<label>
									<input class="xs_radio_filed" name="xs_submit_donation_data[goal_setup][bar_display_sty]" value="percentage"  type="radio" <?php echo ( isset( $wfpFormGoalData['bar_display_sty'] ) && $wfpFormGoalData['bar_display_sty'] == 'percentage' ) ? 'checked' : 'checked'; ?> > <?php echo esc_html__( 'Percentage ', 'wp-fundraising' ); ?>
								</label>
							</li>
							<li>
								<label>
									<input class="xs_radio_filed" name="xs_submit_donation_data[goal_setup][bar_display_sty]" value="amount_show" type="radio" <?php echo ( isset( $wfpFormGoalData['bar_display_sty'] ) && $wfpFormGoalData['bar_display_sty'] == 'amount_show' ) ? 'checked' : ''; ?>  > <?php echo esc_html__( 'Flat', 'wp-fundraising' ); ?>
								</label>
							</li>
							<li>
								<label>
									<input class="xs_radio_filed" name="xs_submit_donation_data[goal_setup][bar_display_sty]" value="both_show" type="radio" <?php echo ( isset( $wfpFormGoalData['bar_display_sty'] ) && $wfpFormGoalData['bar_display_sty'] == 'both_show' ) ? 'checked' : ''; ?>  > <?php echo esc_html__( 'Both', 'wp-fundraising' ); ?>
								</label>
							</li>
						</ul>
					</div>
				...
				<li class="wfdp-social-input-container">
					...
					<div class="wfdp-social-input">
						<ul class="xs-donate-option">
							<li>
								<label>
									<input class="xs_radio_filed" name="xs_submit_donation_data[goal_setup][goal_type]" value="terget_goal"  type="radio" <?php echo ( isset( $wfpFormGoalData['goal_type'] ) && $wfpFormGoalData['goal_type'] == 'terget_goal' ) ? 'checked' : 'checked'; ?> > <?php echo esc_html__( 'Target Goal ', 'wp-fundraising' ); ?>
								</label>
							</li>
							<li>
								<label>
									<input class="xs_radio_filed" name="xs_submit_donation_data[goal_setup][goal_type]" value="terget_date"  type="radio" <?php echo ( isset( $wfpFormGoalData['goal_type'] ) && $wfpFormGoalData['goal_type'] == 'terget_date' ) ? 'checked' : ''; ?>  > <?php echo esc_html__( 'Target Date', 'wp-fundraising' ); ?>
								</label>
							</li>
							<li>
								<label>
									<input class="xs_radio_filed" name="xs_submit_donation_data[goal_setup][goal_type]" value="terget_goal_date" type="radio" <?php echo ( isset( $wfpFormGoalData['goal_type'] ) && $wfpFormGoalData['goal_type'] == 'terget_goal_date' ) ? 'checked' : ''; ?>  > <?php echo esc_html__( 'Target Goal & Date', 'wp-fundraising' ); ?>
								</label>
							</li>
							<li>
								<label>
									<input class="xs_radio_filed" name="xs_submit_donation_data[goal_setup][goal_type]" value="campaign_never_end" type="radio" <?php echo ( isset( $wfpFormGoalData['goal_type'] ) && $wfpFormGoalData['goal_type'] == 'campaign_never_end' ) ? 'checked' : ''; ?>  > <?php echo esc_html__( 'Campaign Never Ends', 'wp-fundraising' ); ?>
								</label>
							</li>
						</ul>
					</div>
