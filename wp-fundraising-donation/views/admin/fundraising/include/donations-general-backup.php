...
<fieldset class="xs-donate-field-wrap xs-clearfix">
	...
	<div class="xs-field-body">
		<ul class="xs-donate-option">
			<li>
				<label>
					<input name="xs_submit_donation_data[donation][format]" onchange="xs_show_hide_donate_multiple('.donation_target_type_filed', '.pledge_setup_target1');" class="xs_radio_filed" value="donation" type="radio" <?php echo ( $wfp_donation_format == 'donation' ) ? 'checked' : ''; ?> > <?php echo esc_html__( 'Single Donation', 'wp-fundraising' ); ?>
				</label>
			</li>
			<li>
				<label>
					<input name="xs_submit_donation_data[donation][format]" value="crowdfunding" type="radio" onchange="xs_show_hide_donate_multiple('.donation_target_type_filed', '.pledge_setup_target');"  class="xs_radio_filed" <?php echo ( $wfp_donation_format == 'crowdfunding' ) ? 'checked' : ''; ?>  > <?php echo esc_html__( 'Crowdfunding', 'wp-fundraising' ); ?>
				</label>
			</li>
		</ul>
...
<fieldset class="xs-donate-field-wrap xs-clearfix donation_target_type_filed pledge_setup_target1 xs-donate-hidden <?php echo esc_attr( $wfp_forms_multiple_price_class ); ?>">
	...
	<div class="xs-field-body">
		<ul class="xs-donate-option">
			<li>
				<label>
				<input name="xs_submit_donation_data[donation][type]" value="multi-lebel" type="radio"  class="xs_radio_filed" onchange="xs_donate_donation_type(1);"  <?php echo ( $wfp_donation_type == 'multi-lebel' ) ? 'checked' : ''; ?> > <?php echo esc_html__( 'Multi Price', 'wp-fundraising' ); ?>
				</label>
			</li>
			<li>
				<label>
				<input name="xs_submit_donation_data[donation][type]" value="fixed-lebel" type="radio"  class="xs_radio_filed" onchange="xs_donate_donation_type(2);" <?php echo ( $wfp_donation_type == 'fixed-lebel' ) ? 'checked' : ''; ?>  > <?php echo esc_html__( 'Fixed Price', 'wp-fundraising' ); ?>
				</label>
			</li>
		</ul>
		...
		<div class="xs-donate-repeatable-field-section xs-donate-hidden <?php echo ( $wfp_donation_type == 'multi-lebel' ) ? 'xs-donate-visible' : ''; ?> ">
			...
			<div class="repater_donate_item">
				...
				<div class="xs-donate-row">
					...
					echo sprintf( esc_html__( 'Donation Level:  %s', 'wp-fundraising' ), isset( $multi->lebel ) ? esc_html( $multi->lebel ) : '' ); ?></span></h2>
...
<fieldset class="xs-donate-field-wrap xs-clearfix xs-donate-repeatable-field-section-display xs-donate-hidden <?php echo ( $wfp_donation_type == 'multi-lebel' ) ? 'xs-donate-visible' : ''; ?>">
	...
	<div class="xs-field-body">
		<ul class="xs-donate-option">
			<li>
				<label>
				<input name="xs_submit_donation_data[donation][display]" value="boxed"  class="xs_radio_filed" type="radio" <?php echo ( $wfpDisplayData == 'boxed' ) ? 'checked' : ''; ?> > <?php echo esc_html__( 'Boxed', 'wp-fundraising' ); ?>
				</label>
			</li>
			<li>
				<label>
				<input name="xs_submit_donation_data[donation][display]" value="radio"  class="xs_radio_filed" type="radio" <?php echo ( $wfpDisplayData == 'radio' ) ? 'checked' : ''; ?>  ><?php echo esc_html__( 'Radio Button', 'wp-fundraising' ); ?>
				</label>
			</li>
			<li>
				<label>
				<input name="xs_submit_donation_data[donation][display]" value="dropdown"  class="xs_radio_filed" type="radio" <?php echo ( $wfpDisplayData == 'dropdown' ) ? 'checked' : ''; ?> > <?php echo esc_html__( 'Dropdown', 'wp-fundraising' ); ?>
				</label>
			</li>
				...
				<div class="xs-donate-field-wrap xs-mb-2">
					...
					<div class="xs_select_input_and_symbol_group">
						...
						<select class="wfp-fees-types xs_select_filed" name="xs_submit_donation_data[donation][set_add_fees][fees_type]">
							<option value="percentage" <?php echo ( $wfp_fees_type == 'percentage' ? 'selected' : '' ); ?> > <?php echo esc_html__( 'Percentage', 'wp-fundraising' ); ?> </option>
							<option value="fixed" <?php echo ( $wfp_fees_type == 'fixed' ? 'selected' : '' ); ?> > <?php echo esc_html__( 'Fixed', 'wp-fundraising' ); ?> </option>
						</select>
					</div>
				</div>
			</div>
