			...
			<ul class="xs-donate-option">
				<li>
					<div class="xs-switch-button_wraper">
						<input class="xs_donate_switch_button" type="checkbox" <?php echo esc_attr( ( isset( $wfpFormGoalData->enable ) && $wfpFormGoalData->enable == 'Yes' ) ? 'checked' : '' ); ?> id="donation_form_goal_enable" name="xs_submit_donation_data[goal_setup][enable]" onchange="xs_show_hide_donate('.xs-donate-goal-content-section');" value="Yes" >
				...
				<div class="goal_terget_amount_show ">
					<div class="xs-donate-field-group xs-donate-field-wrap ">	
						...
						<div class="xs-donate-field-wrap-amount">
							...
							<input type="number" style="" min="0" name="xs_submit_donation_data[goal_setup][terget][terget_goal][amount]" id="xs_donate_fixed_amount" value="<?php echo isset( $wfpFormGoalData->terget->terget_goal->amount ) ? esc_attr( $wfpFormGoalData->terget->terget_goal->amount ) : 0; ?>" placeholder="0.00" class="xs-field xs-money-field xs-text_small">
						</div>
					</div>
					<!--
					<div class="xs-donate-field-group xs-donate-field-wrap xs-donate-field-wrap-with-help-text">
						<label for="xs_donate_fixed_amount_fake"> <?php // echo esc_html__('Fake Raised Amount', 'wp-fundraising-donation'); ?></label>

						<div class="xs-donate-field-wrap-amount">
							<span class="xs-money-symbol xs-money-symbol-before"><?php // echo $wfpSymbols; ?></span>
							<input type="number" style="" min="0" name="xs_submit_donation_data[goal_setup][terget][terget_goal][fake_amount]" id="xs_donate_fixed_amount_fake" value="<?php // echo isset($wfpFormGoalData->terget->terget_goal->fake_amount) ? $wfpFormGoalData->terget->terget_goal->fake_amount : 0; ?>" placeholder="0.00" class="xs-field xs-money-field xs-text_small">
							<span class="xs-donetion-field-description"><?php // echo esc_html__('This is fake raised amount, just show in forms.', 'wp-fundraising-donation'); ?></span>
						</div>
	...
	<div class="xs-field-body">
		<div class="donation-none-float">
			<ul class="xs-donate-option">
				<li>
					<div class="xs-switch-button_wraper">
						<input class="xs_donate_switch_button" type="checkbox" <?php echo esc_attr( ( isset( $wfpFormGoalData->terget->enable ) && $wfpFormGoalData->terget->enable == 'Yes' ) ? 'checked' : '' ); ?> id="donation_form_goal_taget_message_enable" name="xs_submit_donation_data[goal_setup][terget][enable]" onchange="xs_show_hide_donate('.xs-donate-goal-message-section');" value="Yes" >
			...
			<div class="xs-donate-goal-message-section xs-donate-hidden xs-repeater-field-wrap xs-donate-field-wrap-with-help-text <?php echo esc_attr( ( isset( $wfpFormGoalData->terget->enable ) && $wfpFormGoalData->terget->enable == 'Yes' ) ? 'xs-donate-visible' : '' ); ?>">
				...
				<?php
				$wfp_content = isset( $wfpFormGoalData->terget->message ) ? $wfpFormGoalData->terget->message : '';

				$wfp_editor_id = 'form_goal_target_message_editor';
				$wfp_settings  = array(
					'media_buttons' => false,
