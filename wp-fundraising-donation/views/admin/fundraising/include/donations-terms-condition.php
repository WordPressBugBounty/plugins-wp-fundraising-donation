			...
			<div class="xs-donate-field-wrap">
				...
				<div class="xs-donate-field-wrap-amount">
					<ul class="xs-donate-option">
						<li>
							<label>
							<input class="xs_radio_filed" name="xs_submit_donation_data[form_terma][content_position]" value="after-submit-button" type="radio" <?php echo ( isset( $wfpFormTermsData->content_position ) && $wfpFormTermsData->content_position == 'after-submit-button' ) ? 'checked' : 'checked'; ?> > <?php echo esc_html__( 'After Submit Button', 'wp-fundraising' ); ?>
							</label>
						</li>
						<li>
							<label>
							<input class="xs_radio_filed" name="xs_submit_donation_data[form_terma][content_position]" value="before-submit-button" type="radio" <?php echo ( isset( $wfpFormTermsData->content_position ) && $wfpFormTermsData->content_position == 'before-submit-button' ) ? 'checked' : ''; ?>  > <?php echo esc_html__( 'Before Submit Button', 'wp-fundraising' ); ?>
							</label>
						</li>
					</ul>
				</div>
