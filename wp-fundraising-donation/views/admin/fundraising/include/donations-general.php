			...
			<li>
				<label>
					<input name="xs_submit_donation_data[donation][format]"
						   ...
						   value="donation"
						   type="radio" <?php echo esc_attr( $wfp_donation_format == 'donation' ? 'checked' : '' ); ?> > <?php echo esc_html__( 'Single Donation', 'wp-fundraising-donation' ); ?>
				</label>
			</li>
			<li>
				<label>
					<input name="xs_submit_donation_data[donation][format]"
						   ...
						   class="xs_radio_filed" <?php echo esc_attr( $wfp_donation_format == 'crowdfunding' ? 'checked' : '' ); ?>  > <?php echo esc_html__( 'Crowdfunding', 'wp-fundraising-donation' ); ?>
				</label>
			</li>
	...
	<div class="xs-field-body">
		<ul class="xs-donate-option">
			<li>
				...
				<label for="xs_donate_multi_price"><?php echo esc_html__( 'Multi Price', 'wp-fundraising-donation' ); ?></label>
			</li>
			<li>
				...
				<label for="xs_dontate_fixed_price"><?php echo esc_html__( 'Fixed Price', 'wp-fundraising-donation' ); ?></label>
			</li>
		</ul><!-- .xs-donate-option end -->
				...
				<div class="xs-donate-row">
					<div class="xs-repeater-field-wrap xs-opened xs-column" >
						<div class="xs-donate-row-head xs-move" onclick="xs_show_hide_parents_elements(this)" >
							<h2><span class="level_donate_multi"><?php echo esc_html__( 'Donation Level: ', 'wp-fundraising-donation' ); ?><?php echo isset( $multi->lebel ) ? esc_html( $multi->lebel ) : '' . ' '; ?></span></h2>
...
<fieldset class="xs-donate-field-wrap xs-clearfix custom-amount-fieldset <?php echo esc_attr( $wfp_donation_format == 'crowdfunding' ? 'xs-donate-hidden' : '' ); ?>">
	<span class="xs-donate-field-label"><?php echo esc_html__( 'Custom amount', 'wp-fundraising-donation' ); ?></span>
	<div class="xs-field-body">
		<ul class="xs-donate-option">
			<li>
				<div class="xs-switch-button_wraper">
...
<fieldset class="xs-donate-field-wrap xs-clearfix xs-donate-repeatable-field-section-display 
	...
	<div class="xs-field-body">
		<ul class="xs-donate-option">
			<li>
				<label>
				<input name="xs_submit_donation_data[donation][display]" value="boxed"  class="xs_radio_filed" type="radio" <?php echo esc_attr( $wfpDisplayData == 'boxed' ? 'checked' : '' ); ?> > <?php echo esc_html__( 'Boxed', 'wp-fundraising-donation' ); ?>
				</label>
			</li>
			<li>
				<label>
				<input name="xs_submit_donation_data[donation][display]" value="radio"  class="xs_radio_filed" type="radio" <?php echo esc_attr( $wfpDisplayData == 'radio' ? 'checked' : '' ); ?>  ><?php echo esc_html__( 'Radio Button', 'wp-fundraising-donation' ); ?>
				</label>
			</li>
			<li>
				<label>
				<input name="xs_submit_donation_data[donation][display]" value="dropdown"  class="xs_radio_filed" type="radio" <?php echo esc_attr( $wfpDisplayData == 'dropdown' ? 'checked' : '' ); ?> > <?php echo esc_html__( 'Dropdown', 'wp-fundraising-donation' ); ?>
				</label>
			</li>
		</ul>
			...
			<div class="xs-donate-field-wrap-group">
				<div class="xs-donate-field-wrap">
					...
					<select class="wfp-fees-types xs_select_filed" name="xs_submit_donation_data[donation][set_add_fees][fees_type]">
						<option value="percentage" <?php echo esc_attr( ( $wfp_fees_type == 'percentage' ? 'selected' : '' ) ); ?> > <?php echo esc_html__( 'Percentage', 'wp-fundraising-donation' ); ?> </option>
						<option value="fixed" <?php echo esc_attr( ( $wfp_fees_type == 'fixed' ? 'selected' : '' ) ); ?> > <?php echo esc_html__( 'Fixed', 'wp-fundraising-donation' ); ?> </option>
						</select>
					</div>
				</div>
			</div>
...
<fieldset class="xs-donate-field-wrap donation_target_type_filed pledge_setup_target1 xs-donate-hidden <?php echo esc_attr( $wfp_forms_design_class ); ?>">
	<span class="xs-donate-field-label"><?php echo esc_html__( 'Form Styles', 'wp-fundraising-donation' ); ?></span>
	<legend class="screen-reader-text"><?php echo esc_html__( 'Form Styles', 'wp-fundraising-donation' ); ?></legend>

	<div class="xs-field-body xs-repeater-field-wrap">
		<ul class="xs-donate-option">
			<li>
				<label>
					<input class="xs_radio_filed" name="xs_submit_donation_data[form_design][styles]" value="all_fields" type="radio" <?php echo esc_attr( isset( $wfpFormDesignData->styles ) && $wfpFormDesignData->styles == 'all_fields' ) ? 'checked' : 'checked'; ?> onchange="xs_show_hide_donate('.xs-donate-forms-styles-continue-fields');" > <?php echo esc_html__( 'All Fields', 'wp-fundraising-donation' ); ?>
				</label>
			</li>
			<li>
				<label>
					<input class="xs_radio_filed" name="xs_submit_donation_data[form_design][styles]" value="only_button" type="radio" <?php echo esc_attr( isset( $wfpFormDesignData->styles ) && $wfpFormDesignData->styles == 'only_button' ) ? 'checked' : ''; ?> onchange="xs_show_hide_donate('.xs-donate-forms-styles-continue-fields');" ><?php echo esc_html__( 'Only Button', 'wp-fundraising-donation' ); ?>
				</label>
			</li>

			<span class="xs-donetion-field-description"><?php echo esc_html__( 'Set donation form style for donation information', 'wp-fundraising-donation' ); ?></span>
		</ul>
		<div class="xs-donate-forms-styles-continue-fields xs-donate-hidden <?php echo esc_attr( ( isset( $wfpFormDesignData->styles ) && $wfpFormDesignData->styles != 'all_fields' ) ? 'xs-donate-visible' : '' ); ?>">
			<div class="xs-donate-field-wrap border-top-1">
				<label for="xs_donate_forms_design_continue_button" > <?php echo esc_html__( 'Continue Text', 'wp-fundraising-donation' ); ?></label>
				...
				<div class="xs-donate-field-wrap-amount xs-donate-field-wrap-no-symbol">
					...
					<span class="xs-donetion-field-description"><?php echo esc_html__( 'Continue button only apply for design(Only Button, Modal Style)', 'wp-fundraising-donation' ); ?></span>
				</div>
		...
		<div class="xs-donate-forms-styles-submit-fields">
			<div class="xs-donate-field-wrap border-top-1">
				<label for="xs_donate_forms_design_submit_button" > <?php echo esc_html__( 'Submit Text', 'wp-fundraising-donation' ); ?></label>
				...
				<div class="xs-donate-field-wrap-amount xs-donate-field-wrap-no-symbol">
					...
					<span class="xs-donetion-field-description"><?php echo esc_html__( 'Set submit button text.', 'wp-fundraising-donation' ); ?></span>
				</div>

			</div>

			<div class="xs-donate-field-wrap border-top-1">
				<label for="xs_donate_forms_design_submit_button" > <?php echo esc_html__( 'Form show in Modal(Popup)', 'wp-fundraising-donation' ); ?></label>
				...
				<div class="xs-donate-field-wrap-amount">
					...
					<span class="xs-donetion-field-description"><?php echo esc_html__( 'Click continue button after show form in popup.', 'wp-fundraising-donation' ); ?></span>
				</div>
