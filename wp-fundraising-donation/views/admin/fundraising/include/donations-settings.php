			...
			<ul class="xs-donate-option">
				<li>
					<div class="xs-switch-button_wraper">
						<input class="xs_donate_switch_button" type="checkbox" id="donation_form_sidebar_enable__" <?php echo ( $wfpEnableSidebar == 'Yes' ) ? 'checked' : ''; ?> name="xs_submit_donation_data[form_settings][sidebar][enable]" value="Yes">
...
<fieldset class="xs-donate-field-wrap ">
	...
	<div class="donation-none-float">
		<ul class="xs-donate-option">
			<li>
				<div class="xs-switch-button_wraper">
					<input class="xs_donate_switch_button" type="checkbox" id="donation_form_show_campaign_author__" <?php echo ( $wfp_hide_campaign_author == 'Yes' ) ? 'checked' : ''; ?> name="xs_submit_donation_data[form_settings][campaign_author][enable]" value="Yes">
	...
	<fieldset class="xs-donate-field-wrap ">
		...
		<div class="donation-none-float">
			<ul class="xs-donate-option">
				<li>
					<div class="xs-switch-button_wraper">
						<input class="xs_donate_switch_button" type="checkbox" id="donation_form_featured_enable__" <?php echo ( $wfpEnableFeatured == 'Yes' ) ? 'checked' : ''; ?> name="xs_submit_donation_data[form_settings][featured][enable]" value="Yes">
	...
	<fieldset class="xs-donate-field-wrap ">
		...
		<div class="donation-none-float">
			<ul class="xs-donate-option">
				<li>
					<div class="xs-switch-button_wraper">
						<input class="xs_donate_switch_button" type="checkbox" id="donation_form_single_title_enable__" <?php echo ( $wfpEnableTitleSIngle == 'Yes' ) ? 'checked' : ''; ?> name="xs_submit_donation_data[form_settings][single_title][enable]" value="Yes">
	...
	<fieldset class="xs-donate-field-wrap ">
		...
		<div class="donation-none-float">
			<ul class="xs-donate-option">
				<li>
					<div class="xs-switch-button_wraper">
						<input class="xs_donate_switch_button" type="checkbox" id="donation_form_single_excerpt_enable__" <?php echo ( $wfpEnableTitleExcerpt == 'Yes' ) ? 'checked' : ''; ?> name="xs_submit_donation_data[form_settings][single_excerpt][enable]" value="Yes">
	...
	<fieldset class="xs-donate-field-wrap ">
		...
		<div class="donation-none-float">
			<ul class="xs-donate-option">
				<li>
					<div class="xs-switch-button_wraper">
						<input class="xs_donate_switch_button" type="checkbox" id="donation_form_single_content_enable__" <?php echo ( $wfpEnableSingleContent == 'Yes' ) ? 'checked' : ''; ?> name="xs_submit_donation_data[form_settings][single_content][enable]" value="Yes">
	...
	<fieldset class="xs-donate-field-wrap ">
		...
		<div class="donation-none-float">
			<ul class="xs-donate-option">
				<li>
					<div class="xs-switch-button_wraper">
						<input class="xs_donate_switch_button" type="checkbox" id="donation_form_single_review_enable__" <?php echo ( $wfpEnableSingleReview == 'Yes' ) ? 'checked' : ''; ?> name="xs_submit_donation_data[form_settings][single_review][enable]" value="Yes">
	...
	<fieldset class="xs-donate-field-wrap ">
		...
		<div class="donation-none-float">
			<ul class="xs-donate-option">
				<li>
					<div class="xs-switch-button_wraper">
						<input class="xs_donate_switch_button" type="checkbox" id="donation_form_single_updates_enable__" <?php echo ( $wfpEnableSingleUpdates == 'Yes' ) ? 'checked' : ''; ?> name="xs_submit_donation_data[form_settings][single_updates][enable]" value="Yes">
	...
	<fieldset class="xs-donate-field-wrap ">
		...
		<div class="donation-none-float">
			<ul class="xs-donate-option">
				<li>
					<div class="xs-switch-button_wraper">
						<input class="xs_donate_switch_button" type="checkbox" id="donation_form_single_recents_enable__" <?php echo ( $wfpEnableSingleRecents == 'Yes' ) ? 'checked' : ''; ?> name="xs_submit_donation_data[form_settings][single_recents][enable]" value="Yes">
	...
	<fieldset class="xs-donate-field-wrap ">
		...
		<div class="donation-none-float">
			<ul class="xs-donate-option">
				<li>
					<div class="xs-switch-button_wraper">
						<input class="xs_donate_switch_button" type="checkbox" id="donation_form_contributor_enable__" <?php echo ( $wfpEnableContributorEmail == 'Yes' ) ? 'checked' : ''; ?> name="xs_submit_donation_data[form_settings][contributor][enable]" value="Yes">
