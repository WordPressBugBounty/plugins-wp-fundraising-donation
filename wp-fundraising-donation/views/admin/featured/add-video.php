...
<div class="wfp-fundrasing featured-video-metabox-container">
	<div class="featured_video " id="featured_video">
		...
		if ( $this->has_featured_video( $wfp_post_id ) ) {
			echo '<span class="dashicons dashicons-video-alt3" ></span><img src="' . esc_url( $this->get_video_thumbnail( $wfp_post_id ) ) . '">';
		}
		?>
	</div>
	...
	<input type="hidden" value="<?php echo esc_url( $this->get_video_url( $wfp_post_id ) ); ?>" name="wfp_featured_video_url" id="wfp_featured_video_url">
