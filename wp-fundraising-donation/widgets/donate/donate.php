...
class Wfp_Fundraising_Donate extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Donate Button', 'wp-fundraising-donation' );
	}
	...
	public function get_post() {
		...
		// phpcs:ignore WordPress.DB.SlowDBQuery.slow_db_query_meta_query -- meta query is required here to select donation-type forms; acceptable for this admin control list.
	...
	protected function register_controls() {
		...
		$this->add_control(
			...
			array(
				'label'    => __( 'Select Donate', 'wp-fundraising-donation' ),
		...
		$this->add_control(
			...
			array(
				'label'   => esc_html__( 'From Style', 'wp-fundraising-donation' ),
				'type'    => Controls_Manager::SELECT,
				'default' => 'only_button',
				'options' => array(
					'all_fields'  => esc_html__( 'All Fields', 'wp-fundraising-donation' ),
					'only_button' => esc_html__( 'Only Button', 'wp-fundraising-donation' ),
				),
		...
		$this->add_control(
			...
			array(
				'label'   => esc_html__( 'Show Modal', 'wp-fundraising-donation' ),
				'type'    => Controls_Manager::SELECT,
				'default' => 'Yes',
				'options' => array(
					'Yes' => esc_html__( 'Yes', 'wp-fundraising-donation' ),
					'No'  => esc_html__( 'No', 'wp-fundraising-donation' ),
				),
		...
		$this->add_group_control(
			...
			array(
				...
				// phpcs:ignore WordPressVIPMinimum.Performance.WPQueryParams.PostNotIn_exclude -- "exclude" is a control config option (exclude background properties), not a WP_Query/post retrieval.
				'exclude'  => array(
					'image',
				),
			)
		...
		$this->start_controls_section(
			...
			array(
				'label' => esc_html__( 'Input ', 'wp-fundraising-donation' ),
				'tab'   => Controls_Manager::TAB_STYLE,
			)
		);
		...
		$this->add_control(
			...
			array(
				'label'     => __( 'Input', 'wp-fundraising-donation' ),
				'type'      => Controls_Manager::HEADING,
				'separator' => 'after',
			)
		);
		...
		$this->add_group_control(
			...
			array(
				...
				'label'    => esc_html__( 'Background Color', 'wp-fundraising-donation' ),
				'types'    => array( 'classic', 'gradient' ),
				'selector' => '{{WRAPPER}} .wfp-donation-form-wraper .wfdp-donation-input-form .regular-text, {{WRAPPER}} .wfdp-donationForm .wfdp-donation-input-form .xs-donate-field-wrap .xs-field, {{WRAPPER}} .wfdp-donationForm .wfdp-donation-input-form .xs-donate-field-wrap .xs-money-symbol',
			)
		);
		...
		$this->add_control(
			...
			array(
				'label'     => __( 'Radio Input', 'wp-fundraising-donation' ),
				'type'      => Controls_Manager::HEADING,
				'separator' => 'after',
			)
		);
		...
		$this->add_control(
			...
			array(
				'label'     => esc_html__( 'Radio Normal Color', 'wp-fundraising-donation' ),
				'type'      => Controls_Manager::COLOR,
		...
		$this->add_control(
			...
			array(
				'label'     => esc_html__( 'Radio Active Color', 'wp-fundraising-donation' ),
				'type'      => Controls_Manager::COLOR,
		...
		$this->add_control(
			...
			array(
				'label'     => __( 'Label', 'wp-fundraising-donation' ),
				'type'      => Controls_Manager::HEADING,
				'separator' => 'after',
			)
		);
		...
		$this->add_control(
			...
			array(
				'label'     => __( 'Headding', 'wp-fundraising-donation' ),
				'type'      => Controls_Manager::HEADING,
				'separator' => 'after',
			)
		);
	...
	protected function render() {
		...
		if ( empty( $wfp_fundraising_donate_content__select_post ) ) {
			echo esc_html__( 'Select any Donation from Dropdown.', 'wp-fundraising-donation' );
			return '';
		}
		...
		if ( is_object( $post ) ) {
			...
			echo esc_html__( 'Please select any donate.', 'wp-fundraising-donation' );
		}
	}
}
